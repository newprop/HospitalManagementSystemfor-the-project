    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Dhaka", "01823459999", "Hospital Administrator", "krim@gmail.com", null, 0, "Md.Krim" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "+880-171-1234567", 2, "mohammad.rahman@example.com", null, "Dr. Mohammad Rahman", "Sun-Thu 9-1", 0, "Cardiologist" },
                    { 3, "+880-191-9876543", 3, "fatima.ahmed@example.com", null, "Dr. Fatima Ahmed", "Sun-Thu 10-2", 0, "Dermatologist" },
                    { 4, "+880-181-8765432", 4, "ayesha.khan@example.com", null, "Dr. Ayesha Khan", "Sun-Thu 8-12", 0, "Neurologist" },
                    { 5, "+880-171-2345678", 5, "nazia.islam@example.com", null, "Dr. Nazia Islam", "Sat-Thu 9-1", 0, "Obstetrician" },
                    { 6, "+880-191-3456789", 6, "kamal.hossain@example.com", null, "Dr. Kamal Hossain", "Sat-Thu 10-2", 0, "Endocrinologist" },
                    { 7, "+880-181-4567890", 7, "sabrina.yasmin@example.com", null, "Dr. Sabrina Yasmin", "Sat-Thu 8-12", 0, "Ophthalmologist" },
                    { 8, "+880-171-5678901", 8, "rahman.chowdhury@example.com", null, "Dr. Rahman Chowdhury", "Sat-Thu 9-1", 0, "Orthodontist" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Patients",
                columns: new[] { "PatientId", "Address", "Age", "BloodTypeID", "ContactNo", "Dob", "Email", "Gender", "InsuranceInformation", "Name", "Status" },
                values: new object[,]
                {
                    { 1, "123 ABC Street, Dhaka", null, 1, "+880-171-1234567", new DateOnly(1985, 5, 10), "ayesha.rahman@example.com", 2, "Policy #123456", "Ayesha Rahman", "Active" },
                    { 2, "456 XYZ Road, Chittagong", null, 2, "+880-191-2345678", new DateOnly(1990, 8, 15), "mohammad.ali@example.com", 1, "Policy #789012", "Mohammad Ali", "Active" },
                    { 3, "789 LMN Avenue, Sylhet", null, 3, "+880-181-3456789", new DateOnly(1976, 3, 20), "fatima.khan@example.com", 2, "Policy #345678", "Fatima Khan", "Active" },
                    { 4, "321 PQR Lane, Rajshahi", null, 1, "+880-171-4567890", new DateOnly(1982, 10, 5), "rahim.khan@example.com", 1, "Policy #234567", "Rahim Khan", "Active" },
                    { 5, "789 XYZ Street, Khulna", null, 2, "+880-191-5678901", new DateOnly(1995, 7, 15), "nusrat.jahan@example.com", 2, "Policy #890123", "Nusrat Jahan", "Active" },
                    { 6, "147 LMN Road, Barishal", null, 3, "+880-181-6789012", new DateOnly(1988, 12, 25), "kamal.hossain@example.com", 1, "Policy #456789", "Kamal Hossain", "Active" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "101", "Standard Room", 1 },
                    { 2, "102", "General Room ", 1 },
                    { 3, "103", "VIP Room ", 1 },
                    { 4, "104", " Standard Room", 2 },
                    { 5, "105", "General Room  ", 2 },
                    { 6, "106", " VIP Room", 2 },
                    { 7, "107", "Standard Room", 3 },
                    { 8, "108", " General Room ", 3 },
                    { 9, "109", "VIP Room", 3 },
                    { 10, "110", " Standard Room", 4 },
                    { 11, "111", "General Room ", 4 },
                    { 12, "112", " VIP Room", 4 },
                    { 13, "113", "Standard Room", 5 },
                    { 14, "114", " General Room", 5 },
                    { 15, "115", "VIP Room ", 5 },
                    { 16, "116", " Standard Room", 6 },
                    { 17, "107", "General Room", 6 },
                    { 18, "118", " VIP Room ", 6 },
                    { 19, "119", "General Room", 7 },
                    { 20, "120", " Standard Room", 7 }
                });
